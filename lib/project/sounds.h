// Get sound from this link: http://www.orangefreesounds.com
// or from: https://www.soundsnap.com
...
static const String sounds[] = {"Connection", "Disconnection", "Button Pushed", "Mode1", "Mode2", "Mode3", "Surprise",
 "OhOoh", "OhOoh2", "Cuddly", "Sleeping", "Happy", "SuperHappy", "Happy Short", "Sad", "Confused", "Fart 1", "Fart 2",
 "Fart 3", "Beep", "Beep Up", "Beep Down", "Bird Song"};
//static const String sounds[] = {"Birds", "Ocean", "Crickets", "Music Box", "Waterfall", "Start Up", "Wake Up!!!", "Cuckoo"};
